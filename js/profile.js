    ...
    .map(
      (address) => `
        <div class="address-card ${
          address.mainAddress ? "main-address" : ""
            ...
            <div class="address-header">
                ...
                <div class="address-actions">
                    ...
                    <button class="btn-icon btn-danger" onclick="deleteAddress('${
                      address.id
                    }')" title="Excluir">
  ...
  try {
    const updateData = {
      ...
      gender: formData.get("gender")
        ? Number.parseInt(formData.get("gender"))
        : null,
      addresses: currentAddresses.map((addr) => ({
        ...
        completName: addr.completName || "Insira seu Nome Completo",
        gender: addr.gender,
      })),
    };
    ...
    showMessage(
      error.message || "Erro ao atualizar informações pessoais",
      "error"
    );
  }
}
    ...
    if (address) {
      ...
      if (address.state !== undefined && address.state !== null) {
        ...
        if (
          ...
          stateEnumToIndex[address.state]
        ) {
