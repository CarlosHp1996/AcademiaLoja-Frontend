document.addEventListener("DOMContentLoaded", () => {
  ...
  const API_BASE_URL_ADMIN =
    "https://academialoja-production.up.railway.app/api";
  //const API_BASE_URL_ADMIN = "https://localhost:4242https://academialoja-production.up.railway.app/api"
  ...
  function checkAdminAccess() {
    ...
    if (!isAuthenticated || userRole !== "Admin") {
      ...
      if (window.authNotifications) {
        window.authNotifications.accessDenied(
  ...
  function loadSection(sectionId) {
    ...
    contentArea.innerHTML = `<div class="loading-spinner"><i class="fas fa-spinner fa-spin"></i> Carregando ${
      sectionId || "seção"
    }...</div>`;
    // if (adminHeaderTitle) {
  ...
  async function loadTracking() {
    ...
    document.getElementById("view-orders-btn").addEventListener("click", () => {
      ...
      document
        .getElementById("view-trackings-btn")
  ...
  async function fetchAndDisplayProducts() {
    ...
    const result = await fetchData(
      `${API_BASE_URL_ADMIN}/Product/get?PageSize=1000&Page=1`,
      {},
      container
    );
    if (result && result.hasSuccess && result.value && result.value.products) {
      ...
      container.innerHTML = `<p class="error">Erro: ${result.errors.join(
        ", "
      )}</p>`;
    } else if (!result) {
  ...
  function renderProductTable(products) {
    ...
    function renderPage(page) {
          ...
          tableHTML += `
            ...
            p.isActive ? "Sim" : "Não"
              ...
              <td>
                ...
                <button class="btn btn-sm btn-delete-btn" data-id="${
                  p.id
      ...
      if (totalPages > 1) {
        tableHTML += generatePaginationControls(
          page,
          totalPages,
          startIndex,
          endIndex,
  ...
  function showProductForm(product = null) {
        ...
        <div class="admin-form">
            ...
            <form id="product-form" enctype="multipart/form-data">
                ...
                <input type="hidden" id="inventoryId" name="InventoryId" value="${
                  isEditing ? product.inventoryId || "" : ""
                }">
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="productName">Nome:</label>
                        <input type="text" id="productName" name="Name" required value="${
                          isEditing ? product.name : ""
                        }" class="form-control">
                    </div>
                    <div class="form-group col-md-3">
                        <label for="productPrice">Preço (R$):</label>
                        <input type="number" id="productPrice" name="Price" step="0.01" required value="${
                          isEditing ? product.price : ""
                        }" class="form-control">
                    </div>
                    <div class="form-group col-md-3">
                        <label for="productStock">Estoque:</label>
                        <input type="number" id="productStock" name="StockQuantity" required value="${
                ...
                <div class="form-group">
                    ...
                    <textarea id="productDescription" name="Description" required class="form-control">${
                      isEditing ? product.description : ""
                    }</textarea>
                </div>
                <div class="form-group">
                    <label for="productBenefit">Benefícios:</label>
                    <textarea id="productBenefit" name="Benefit" required class="form-control">${
                      isEditing ? product.benefit : ""
                    }</textarea>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <select id="productFlavor" name="Attributes[0].Flavor" class="form-control" required>
                            ...
                            <option value="Baunilha" ${
                              attributes.flavor === "Baunilha" ? "selected" : ""
                            }>Baunilha</option>
                            <option value="Morango" ${
                              attributes.flavor === "Morango" ? "selected" : ""
                            }>Morango</option>
                            <option value="SemSabor" ${
                              attributes.flavor === "SemSabor" ? "selected" : ""
                            }>Sem Sabor</option>
                        </select>
                    </div>
                    <div class="form-group col-md-4">
                        ...
                        <select id="productBrand" name="Attributes[0].Brand" class="form-control" required>
                            <option value="">Selecione</option>
                            <option value="MaxTitanium" ${
                              attributes.brand === "MaxTitanium"
                                ? "selected"
                                : ""
                            }>Max Titanium</option>
                            <option value="Growth" ${
                              attributes.brand === "Growth" ? "selected" : ""
                            }>Growth</option>
                            <option value="IntegralMedica" ${
                              attributes.brand === "IntegralMedica"
                                ? "selected"
                                : ""
                            }>Integral Medica</option>
                            <option value="Probiotica" ${
                              attributes.brand === "Probiotica"
                                ? "selected"
                                : ""
                            }>Probiótica</option>
                            <option value="BlackSkull" ${
                              attributes.brand === "BlackSkull"
                                ? "selected"
                                : ""
                            }>Black Skull</option>
                            <option value="Ftw" ${
                              attributes.brand === "Ftw" ? "selected" : ""
                            }>Ftw</option>
                        </select>
                    </div>
                    <div class="form-group col-md-4">
                        ...
                        <select id="productAccessory" name="Attributes[0].Accessory" class="form-control" required>
                            ...
                            <option value="Camisetas" ${
                              attributes.accessory === "Camisetas"
                                ? "selected"
                                : ""
                            }>Camisetas</option>
                            <option value="Coqueteleira" ${
                              attributes.accessory === "Garrafas"
                                ? "selected"
                                : ""
                            }>Garrafas</option>
                            <option value="Squeeze" ${
                              attributes.accessory === "Shakeiras"
                                ? "selected"
                                : ""
                            }>Shakeiras</option>
                            <option value="Nenhum" ${
                              attributes.accessory === "Nenhum"
                                ? "selected"
                                : ""
                            }>Nenhum</option>
                        </select>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <select id="productCategory" name="Attributes[0].Category" class="form-control" required>
                            <option value="">Selecione</option>
                            <option value="WheyProtein" ${
                              attributes.category === "WheyProtein"
                                ? "selected"
                                : ""
                            }>Whey Protein</option>
                            <option value="Hipercalorico" ${
                              attributes.category === "Hipercalorico"
                                ? "selected"
                                : ""
                            }>Hipercalórico</option>
                            <option value="Creatina" ${
                              attributes.category === "Creatina"
                                ? "selected"
                                : ""
                            }>Creatina</option>
                            <option value="Vitaminas" ${
                              attributes.category === "Vitaminas"
                                ? "selected"
                                : ""
                            }>Vitaminas</option>
                            <option value="PreTreino" ${
                              attributes.category === "PreTreino"
                                ? "selected"
                                : ""
                            }>Pré Treino</option>
                            <option value="Glutamina" ${
                              attributes.category === "Glutamina"
                                ? "selected"
                                : ""
                            }>Glutamina</option>
                        </select>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select id="productObjective" name="Attributes[0].Objective" class="form-control" required>
                            ...
                            <option value="Emagrecimento" ${
                              attributes.objective === "Emagrecimento"
                                ? "selected"
                                : ""
                            }>Emagrecimento</option>
                            <option value="AumentoDeMassaMuscular" ${
                              attributes.objective === "AumentoDeMassaMuscular"
                                ? "selected"
                                : ""
                            }>Ganho de Massa</option>
                            <option value="Hipertrofia" ${
                              attributes.objective === "Hipertrofia"
                                ? "selected"
                                : ""
                            }>Energia</option>
                            <option value="Ganho de Peso" ${
                              attributes.objective === "GanhoDePeso"
                                ? "selected"
                                : ""
                            }>Ganho de Peso</option>
                            <option value="MelhoraDeImunidade" ${
                              attributes.objective === "MelhoraDeImunidade"
                                ? "selected"
                                : ""
                            }>Melhora De Imunidade</option>
                        </select>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        ${
                          isEditing && product.imageUrl
                            ? `<div class="current-img-container"><img src="${product.imageUrl}" alt="Imagem atual" width="50" class="current-img"></div>`
                            : ""
                        }
                    </div>
                    <div class="form-group col-md-4">
                        ...
                        ${
                          isEditing && product.nutritionalInfo
                            ? `<div class="current-img-container"><img src="${product?.nutritionalInfo}" alt="Tabela Nutricional" width="50" class="current-img"></div>`
                            : ""
                        }
                    </div>
                    <div class="form-group col-md-6 form-check-group">
                        <div class="form-check">
                            <input type="checkbox" id="productIsActive" name="IsActive" class="form-check-input" ${
                              isEditing
                                ? product.isActive
                                  ? "checked"
                                  : ""
    ...
    document
      .getElementById("cancel-product-form")
      .addEventListener("click", hideProductForm);
    document
      .getElementById("cancel-product-form-secondary")
      .addEventListener("click", hideProductForm);
  }
  ...
  async function handleSaveProduct(event) {
    ...
    formData.set(
      "IsActive",
      document.getElementById("productIsActive").checked.toString()
    );
    ...
    try {
      ...
      if (!response.ok) {
        const errorData = await response
          .json()
          .catch(() => ({ errors: [`Erro ${response.status}`] }));
        throw new Error(
          errorData.errors
      ...
      if (result.hasSuccess) {
        window.showNotification(
          `${
            isEditing ? "Produto atualizado" : "Produto adicionado"
          } com sucesso!`,
          "success"
        );
        hideProductForm();
        ...
        throw new Error(
          result.errors ? result.errors.join(", ") : "Erro ao salvar produto."
        );
      }
    } catch (error) {
  ...
  async function handleEditProduct(event) {
    ...
    const result = await fetchData(
      `${API_BASE_URL_ADMIN}/Product/get/${productId}`,
      {},
      container
    );
  ...
  async function handleDeleteProduct(event) {
    ...
    try {
      const response = await fetch(
        `${API_BASE_URL_ADMIN}/Product/delete/${productId}`,
        {
          method: "DELETE",
          headers: headers,
        }
      ...
      if (result.hasSuccess) {
        ...
        throw new Error(
          result.errors ? result.errors.join(", ") : "Erro ao excluir produto."
        );
      }
    } catch (error) {
  ...
  async function fetchAndDisplayUsers() {
    ...
    const result = await fetchData(
      `${API_BASE_URL_ADMIN}/Auth/get?PageSize=1000&Page=1`,
      {},
      container
    );
            ...
            <form id="user-form">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" id="userName" name="Name" required value="${
                          isEditing ? user.name : ""
                        }">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="userEmail">Email:</label>
                        <input type="email" id="userEmail" name="Email" required value="${
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6 form-check-group">
                        <input type="checkbox" id="userIsActive" name="IsActive" ${
                          isEditing
                            ? user.isActive
                              ? "checked"
                              : ""
  ...
  async function handleSaveUser(event) {
    ...
    try {
      ...
      if (result.hasSuccess) {
        window.showNotification(
          `${
            isEditing ? "Usuário atualizado" : "Usuário adicionado"
          } com sucesso!`,
          "success"
        );
        hideUserForm();
        ...
        throw new Error(
          result.errors ? result.errors.join(", ") : "Erro ao salvar usuário."
        );
      }
    } catch (error) {
  ...
  async function handleEditUser(event) {
    ...
    const result = await fetchData(
      `${API_BASE_URL_ADMIN}/Auth/get/${userId}`,
      {},
      container
    );
    if (result && result.hasSuccess && result.value) {
  ...
  async function handleDeleteUser(event) {
    ...
    try {
      const response = await fetch(
        `${API_BASE_URL_ADMIN}/Auth/delete/${userId}`,
        {
          method: "DELETE",
          headers: headers,
        }
      ...
      if (result.hasSuccess) {
        ...
        throw new Error(
          result.errors ? result.errors.join(", ") : "Erro ao excluir usuário."
        );
      }
    } catch (error) {
  ...
  async function fetchAndDisplayOrders() {
    ...
    const result = await fetchData(
      `${API_BASE_URL_ADMIN}/Order/get?PageSize=1000&Page=1`,
      {},
      container
    );
    ...
    function renderPage(page) {
      ...
      if (paginatedOrders.length === 0) {
        ...
        paginatedOrders.forEach((order) => {
          const userIdentifier = order.user
            ? order.userName
          ...
          tableHTML += `
            ...
            order.status || "N/A"
              ...
              <td><span class="status status-${order.paymentMethod?.toLowerCase()}">${
            order.paymentMethod || "N/A"
          }</span></td>
              <td>
                <button class="btn btn-sm btn-toggle-active ${
                  order.isActive ? "btn-success" : "btn-secondary"
                }" data-id="${order.id}" data-is-active="${order.isActive}">
                  <i class="fas ${
                    order.isActive ? "fa-check" : "fa-times"
                  }"></i>
                </button>
              </td>
            </tr>`;
      ...
      if (totalPages > 1) {
        tableHTML += `
          <div class="pagination-container">
            <div class="pagination-info">
              ...
              <span class="ml-3">Mostrando ${startIndex + 1}-${Math.min(
          endIndex,
          orders.length
        )} de ${orders.length} pedidos</span>
            </div>
        ...
        // Botão Anterior
        if (page > 1) {
          tableHTML += `<button class="btn btn-sm btn-outline-secondary pagination-btn" data-page="${
            page - 1
  ...
  async function handleOrderIsActiveChange(event) {
    ...
    try {
      const response = await fetch(
        `${API_BASE_URL_ADMIN}/Order/update/${orderId}`,
        {
          method: "PUT",
          headers: headers,
      ...
      if (response.ok) {
        window.showNotification(
          `Pedido ${newIsActive ? "ativado" : "desativado"} com sucesso!`,
          "success"
        );
        // Update button state
          ...
          tableHTML += `
            <tr>
              <td>
                ...
                <small class="order-id text-muted d-block">${order.id.substring(
                  0,
                  8
                )}...</small>
              </td>
            ...
            order.status || "N/A"
              ...
              <td>
                <button class="btn btn-sm btn-primary btn-create-tracking" data-order-id="${
                  order.id
                }" data-order-number="${order.orderNumber}">
                  <i class="fas fa-plus"></i> Criar Rastreamento
                </button>
                <button class="btn btn-sm btn-info btn-view-tracking" data-order-id="${
                  order.id
                }">
      ...
      <div class="tracking-header">
        ${
          ...
          <div class="filter-info">
            ...
            Mostrando rastreamentos para o pedido: <strong>${filterOrderId.substring(
              0,
              8
            )}...</strong>
          ...
          tableHTML += `
            <tr>
              <td>
                ...
                <small class="order-id text-muted d-block">${t.orderId.substring(
                  0,
                  8
                )}...</small>
              </td>
            ...
            t.status
              ...
              <td>
                <button class="btn btn-sm btn-edit btn-edit-tracking" data-id="${
                  t.id
                }">
                  <i class="fas fa-edit"></i> Editar
                </button>
                <button class="btn btn-sm btn-delete btn-delete-tracking" data-id="${
                  t.id
                }">
  ...
  function showTrackingForm(
                ...
                <form id="tracking-form">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <small class="form-text text-muted">
                                ${
                                  orderId
                                    ? "Pedido selecionado automaticamente"
                                    : "Cole o ID completo do pedido"
                                }
                            </small>
                        </div>
                        <div class="form-group col-md-6">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <select id="trackingStatus" name="Status" required class="form-control">
                                ...
                                <option value="Pedido Criado" ${
                                  isEditing &&
                                  tracking.status === "Pedido Criado"
                                    ? "selected"
                                    : ""
                                }>Pedido Criado</option>
                                <option value="Preparando" ${
                                  isEditing && tracking.status === "Preparando"
                                    ? "selected"
                                    : ""
                                }>Preparando</option>
                                <option value="Enviado" ${
                                  isEditing && tracking.status === "Enviado"
                                    ? "selected"
                                    : ""
                                }>Enviado</option>
                                <option value="Em Trânsito" ${
                                  isEditing && tracking.status === "Em Trânsito"
                                    ? "selected"
                                    : ""
                                }>Em Trânsito</option>
                                <option value="Saiu para Entrega" ${
                                  isEditing &&
                                  tracking.status === "Saiu para Entrega"
                                    ? "selected"
                                    : ""
                                }>Saiu para Entrega</option>
                                <option value="Entregue" ${
                                  isEditing && tracking.status === "Entregue"
                                    ? "selected"
                                    : ""
                                }>Entregue</option>
                                <option value="Tentativa de Entrega" ${
                                  isEditing &&
                                  tracking.status === "Tentativa de Entrega"
                                    ? "selected"
                                    : ""
                                }>Tentativa de Entrega</option>
                                <option value="Devolvido" ${
                                  isEditing && tracking.status === "Devolvido"
                                    ? "selected"
                                    : ""
                                }>Devolvido</option>
                            </select>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="datetime-local" id="trackingEventDate" name="EventDate" required 
                                   value="${
                                     isEditing && tracking.eventDate
                                       ? new Date(tracking.eventDate)
                                           .toISOString()
                                           .slice(0, 16)
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="trackingDescription" name="Description" rows="3" 
                                  class="form-control" placeholder="Descreva detalhes sobre este evento de rastreamento...">${
                                    isEditing ? tracking.description || "" : ""
                                  }</textarea>
                    </div>
    ...
    document
      ...
      .addEventListener("submit", handleSaveTracking);
    document
      .getElementById("cancel-tracking-form")
      .addEventListener("click", hideTrackingForm);
    document
      .getElementById("cancel-tracking-form-secondary")
      .addEventListener("click", hideTrackingForm);
  }
  ...
  async function handleSaveTracking(event) {
    ...
    const url = isEditing
      ? `${API_BASE_URL_ADMIN}/Tracking/${trackingId}`
      : `${API_BASE_URL_ADMIN}/Tracking`;
    const method = isEditing ? "PUT" : "POST";
    ...
    try {
      ...
      if (result.hasSuccess) {
        window.showNotification(
          `${
            isEditing ? "Rastreamento atualizado" : "Rastreamento criado"
          } com sucesso!`,
          "success"
        );
        hideTrackingForm();
        ...
        throw new Error(
          result.errors
            ? result.errors.join(", ")
            : "Erro ao salvar rastreamento."
        );
      }
    } catch (error) {
      console.error("Erro ao salvar rastreamento:", error);
      window.showNotification(
        `Erro ao salvar rastreamento: ${error.message}`,
        "error"
      );
    }
  }
  ...
  async function handleEditTracking(event) {
    ...
    if (result && result.hasSuccess && result.value) {
      ...
      hideTrackingForm();
      window.showNotification(
        "Erro ao carregar dados do rastreamento.",
        "error"
      );
    }
  }
  ...
  async function handleDeleteTracking(event) {
    const trackingId = event.currentTarget.getAttribute("data-id");
    if (!confirm("Tem certeza que deseja excluir este evento de rastreamento?"))
      return;
    ...
    try {
      ...
      if (result.hasSuccess) {
        ...
        throw new Error(
          result.errors
            ? result.errors.join(", ")
            : "Erro ao excluir rastreamento."
        );
      }
    } catch (error) {
      console.error("Erro ao excluir rastreamento:", error);
      window.showNotification(
        `Erro ao excluir rastreamento: ${error.message}`,
        "error"
      );
    }
  }
  ...
  function generatePaginationControls(
    ...
    // Botão Anterior
    if (currentPage > 1) {
      paginationHTML += `<button class="btn btn-sm btn-outline-secondary pagination-btn" data-page="${
        currentPage - 1
      }" title="Página anterior">
        <i class="fas fa-angle-left"></i>
      </button>`;
