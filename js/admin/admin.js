document.addEventListener("DOMContentLoaded", function () {
  ...
  function showNotification(message, type = "info") {
    if (
      ...
      typeof window.authNotifications.showNotification === "function"
    ) {
  ...
  if (sidebarToggle && adminSidebar) {
    sidebarToggle.addEventListener("click", function () {
      ...
      if (adminMain) {
        adminMain.style.transition =
          "margin-left 0.4s cubic-bezier(0.4, 0, 0.2, 1)";
        adminMain.style.marginLeft = adminSidebar.classList.contains(
          "collapsed"
        )
  ...
  // API base URL
  window.apiBaseUrl = "https://academialoja-production.up.railway.app/api";
  ...
  document.addEventListener("click", function (e) {
    const isClickInside =
      adminSidebar.contains(e.target) || mobileToggle.contains(e.target);
