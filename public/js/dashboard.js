        ...
        <div class="order-card" data-order-id="${order.id}">
            <div class="order-header">
                <div class="order-info">
                    <h3 class="order-number">Pedido #${order.orderNumber || order.id.substring(0, 8)}</h3>
                    <span class="order-date">${formatDate(order.createdAt || order.orderDate)}</span>
                </div>
            ...
            <div class="order-footer">
                <div class="order-total">
                    <span>Total:</span>
                    <strong>R$ ${formatPrice(order.totalAmount || order.total || 0)}</strong>
                </div>
      ...
      (item) => `
        <div class="order-item">
            <div class="item-image">
                ...
                <h4 class="item-name">${item.productName || item.name || "Produto"}</h4>
            </div>
            <div class="item-details">
                <h4 class="item-name">${item.productName || item.name || "Produto"}</h4>
                <p class="item-variant">${item.variant || item.description || ""}</p>
