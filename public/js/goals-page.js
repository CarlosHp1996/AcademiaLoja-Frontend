document.addEventListener('DOMContentLoaded', function() {
    ...
    const goalsPagesGrid = document.querySelector('.goals-page-grid');
    ...
    const goalPage = [
        {
            ...
            rating: 4.5,
            ratingCount: 18,
            image: '/assets/images/goals-page/tshirt.jpg'
        },
        {
            id: 2,
            ...
            rating: 4.0,
            ratingCount: 12,
            image: '/assets/images/goals-page/shaker.jpg'
        },
        {
            id: 3,
            ...
            rating: 5.0,
            ratingCount: 24,
            image: '/assets/images/goals-page/gloves.jpg'
        },
        {
            id: 4,
            ...
            rating: 3.0,
            ratingCount: 8,
            image: '/assets/images/goals-page/towel.jpg'
        }
    ];
    ...
    function initEvents() {
        ...
        document.querySelectorAll('.add-to-cart').forEach(button => {
            button.addEventListener('click', function() {
                const card = this.closest('.goals-page-card');
                const productName = card.querySelector('.goals-page-title').textContent;
