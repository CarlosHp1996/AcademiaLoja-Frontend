// Componente de header e footer padronizado com suporte a autenticação
document.addEventListener('DOMContentLoaded', function() {
    ...
    <header class="header">
        <div class="container">
            <div class="header-left">
                <a href="/public/html/index.html" class="logo">
            ...
            <div class="header-right">
                ...
                <div class="user-dropdown">
                    <button class="user-icon-btn" aria-label="Conta">
                        <i class="fas fa-user"></i>
                    </button>
                    <!-- O conteúdo do dropdown será gerado dinamicamente pelo auth-service.js -->
                </div>
            </div>
        </div>
    </header>
    ...
    function applyHeaderFooter() {
        ...
        // Inicializa o serviço de autenticação para atualizar o dropdown
